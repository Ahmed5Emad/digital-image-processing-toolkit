...
8. [x] Implement `src/processors/frequency.py` (Ideal/Butterworth/Gaussian Low/High Pass variants, Band Reject).
9. [x] Implement `src/processors/segmentation.py` (Point and Line detection).
10. [x] Update all `FILTERS_CONFIG` in `restorer_gui.py`, simplify inputs (static vs. dynamic).
